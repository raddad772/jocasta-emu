...
u32 do_read24(void *ptr, u32 addr) {
    return do_read(ptr, addr, 3) & 0xFFFFFF;
}

void do_write24(void *ptr, u32 addr, u32 val) {
    do_write(ptr, addr, 3, val);
}
...
void test_r3000() {
    ...
    gstate.cpu.read24_unaligned = &do_read24;
    gstate.cpu.write24_unaligned = &do_write24;
