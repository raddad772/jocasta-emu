...
JOCASTA_LIB_PATH = os.path.expanduser('~') + '/dev/jocasta-emu/jocasta-lib/src'

DC_PATH = JOCASTA_LIB_PATH + '/system/dreamcast/generated'
SH4_PATH = JOCASTA_LIB_PATH + '/component/cpu/sh4/generated'
