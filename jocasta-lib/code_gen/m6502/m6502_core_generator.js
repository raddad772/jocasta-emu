...
class m6502_switchgen {
    ...
    regular_end() {
        ...
        if (this.post_poll_code)
            this.addl(this.post_poll_code);
...
/*    let outstr = '#include "helpers/int.h"\n' +
    ...
    let header = '#ifndef _JOCASTA_M6502_OPCODES_H\n' +
        '#define _JOCASTA_M6502_OPCODES_H\n' +
        '\n' +
