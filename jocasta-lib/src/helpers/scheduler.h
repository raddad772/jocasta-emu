...
struct scheduled_bound_function { scheduler_callback func[2]; void *ptr; u32 saveinfo; };
...
struct scheduler_t {
    ...
    u64 bind_or_run(scheduler_event *e, void *ptr, scheduler_callback func, scheduler_callback func_debug, i64 timecode, u64 key, u32 *still_sched);
    ...
    template<bool do_debug> u64 add_or_run_abs(i64 timecode, u64 key, void *ptr, scheduler_callback callback, scheduler_callback callback_debug, u32 *still_sched);
    u64 only_add_abs_w_tag(i64 timecode, u64 key, void *ptr, scheduler_callback callback, u32 *still_sched, u32 tag);
    u64 only_add_abs_w_tag(i64 timecode, u64 key, void *ptr, scheduler_callback callback, scheduler_callback callback_debug, u32 *still_sched, u32 tag);
    u64 only_add_abs(i64 timecode, u64 key, void *ptr, scheduler_callback callback, u32 *still_sched);
    u64 only_add_abs(i64 timecode, u64 key, void *ptr, scheduler_callback callback, scheduler_callback callback_debug, u32 *still_sched);
    u64 add_next(u64 key, void *ptr, scheduler_callback callback, u32 *still_sched);
    u64 add_next(u64 key, void *ptr, scheduler_callback callback, scheduler_callback callback_debug, u32 *still_sched);
    scheduler_event *add_abs(i64 timecode, u64 key, u32 do_instant);
    void run_for_cycles(u64 howmany);
    template<bool do_debug> void run_for_cycles_tg16(u64 howmany);
    template<bool do_debug> void run_til_tag_tg16(u32 tag);
    template<bool do_debug> void run_til_tag(u32 tag);
    void from_event_adjust_master_clock(i64 howmany);
    void clear();
    [[nodiscard]] inline i64 current_time() const { return static_cast<i64>(*clock); };

    [[nodiscard]] inline i64 next_event_timecode() const { return first_event ? first_event->timecode : -1; }
    u64 add_after_first_event(void *ptr, scheduler_callback callback, scheduler_callback callback_debug, u32 *still_sched);
private:
