...
void tg16_present(physical_io_device &device, void *out_buf, u32 out_width, u32 out_height, u32 is_event_view_present, events_view *evp, const jsm_present_context *ctx = nullptr);
