...
void core::bus_cycle_iaq()
{
    switch(state.bus_cycle_iaq.TCU) {
        ...
        case 1:
            pins.AS = 1;
            state.bus_cycle_iaq.ilevel = state.exception.interrupt.new_I;
            // Set A1-3 to ilevel
...
u32 core::read_ea_addr(u32 opnum, u32 sz, bool hold, u32 prefetch)
{
    u32 v, c;
    i64 a, b;
...
template void core::exc_interrupt<false>();
template void core::exc_interrupt<true>();
