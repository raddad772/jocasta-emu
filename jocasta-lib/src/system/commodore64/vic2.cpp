...
void core::setup_timing() {
    ...
    switch (bus->display_standard) {
        case jsm::display_standards::NTSC: {
            ...
            // NTSC crystal 14.31818 MHz / 14 = 1,022,727.3 Hz CPU; / (65 x 263) ... ~59.826 Hz
        ...
        case jsm::display_standards::PAL: {
            ...
            // PAL crystal 17.734472 MHz / 18 = 985,248.4 Hz CPU; / (63 x 312) ... ~50.124 Hz
    ...
    timing.frame.cycles_per = timing.line.cycles_per * timing.frame.lines_per;
    timing.second.cycles_per = static_cast<u32>(timing.frame.cycles_per * timing.second.frames_per);
}
