...
struct core {
    ...
    u32 palette[16]{};
    u8 COLOR[1024]{}; // 4bit
    u16 SCREEN_MTX[40]{}; // 8 bit video matrix + 4 bit color RAM
    u8 open_bus{};
    u16 g_access{};
    u32 px_shifter{};
    u8 shift_size{};
    ...
    struct {
        ...
        struct {
            u32    cycles_per{};  // frame.cycles_per * frames_per, rounded = CPU Hz
            double frames_per{};  // exact fps derived from crystal
        } second {};
