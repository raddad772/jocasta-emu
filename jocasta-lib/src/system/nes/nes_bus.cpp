...
NES::core::core() : cpu(this), ppu(this), cart(this) {
    has.save_state = true;
    has.load_BIOS = false;
...
void NES::core::set_which_mapper(u32 wh)
{
    delete mapper;
    mapper = nullptr;
...
u32 NES::core::CPU_read(u32 addr, u32 old_val, u32 has_effect)
{
    if (addr < 0x2000)
...
void NES::core::CPU_write(u32 addr, u32 val)
{
    if (addr < 0x2000) {
...
u32 NES::core::PPU_read_effect(u32 addr)
{
    addr &= 0x3FFF;
...
u32 NES::core::PPU_read_noeffect(u32 addr)
{
    addr &= 0x3FFF;
...
void NES::core::PPU_write(u32 addr, u32 val)
{
    addr &= 0x3FFF;
...
void NES::core::set_cart(physical_io_device &pio)
{
...
void NES::core::map_PRG32K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
    NES_memmap_map(CPU_map, 13, range_start, range_end, buf, bank << 15, is_readonly, dbg.interface, 0, SRAM);
}

void NES::core::map_PRG16K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
    NES_memmap_map(CPU_map, 13, range_start, range_end, buf, bank << 14, is_readonly, dbg.interface, 0, SRAM);
}

void NES::core::map_PRG8K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
    NES_memmap_map(CPU_map, 13, range_start, range_end, buf, bank << 13, is_readonly, dbg.interface, 0, SRAM);
}

void NES::core::map_CHR1K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
    NES_memmap_map(PPU_map, 10, range_start, range_end, buf, bank << 10, is_readonly, nullptr, 1, SRAM);
}

void NES::core::map_CHR2K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
    NES_memmap_map(PPU_map, 10, range_start, range_end, buf, bank << 11, is_readonly, nullptr, 1, SRAM);
}

void NES::core::map_CHR4K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
    NES_memmap_map(PPU_map, 10, range_start, range_end, buf, bank << 12, is_readonly, nullptr, 1, SRAM);
}

void NES::core::map_CHR8K(u32 range_start, u32 range_end, simplebuf8 *buf, u32 bank, u32 is_readonly)
{
