...
void MMC3b_DXROM::remap(bool is_boot)
{
    ...
    debugger_interface_dirty_mem(bus->dbg.interface, NESMEM_CPUBUS, 0x8000, 0xFFFF);
}
...
void MMC3b_DXROM::setcart(CART &cart)
{
...
MMC3b_DXROM::MMC3b_DXROM(core *bus, mappers in_kind) : MAPPER(bus), kind(in_kind), a12(&bus->clock)
{
