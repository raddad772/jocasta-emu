...
/*
*    VRC2a -> Mapper 22 (submapper 0)
*    VRC2b -> Mapper 23 (submapper 3)
*    VRC2c -> Mapper 25 (submapper 3)
*    VRC4a -> Mapper 21 (submapper 1)
*    VRC4b -> Mapper 25 (submapper 1)
*    VRC4c -> Mapper 21 (submapper 2)
*    VRC4d -> Mapper 25 (submapper 2)
*    VRC4e -> Mapper 23 (submapper 2)
*    VRC4f -> Mapper 23 (submapper 1)*/

#define THISM VRC24 *th = static_cast<VRC24 *>(bus->mapper_ptr)
...
void VRC2B_4E_4F::setcart(CART &cart)
{
    bus->ppu_mirror_mode = cart.header.mirroring;

    io.wram_enabled = bus->cart.header.prg_ram_size > 0;
}
...
VRC2B_4E_4F::VRC2B_4E_4F(core *bus, mappers in_kind) : MAPPER(bus), kind(in_kind)
{
