...
u32 CART::read_ines1_header(const char *fil, size_t fil_sz)
{
    ...
    header.mirroring = static_cast<PPU_mirror_modes>(fil[6] & 1);
...
u32 CART::read_ines2_header(const char *fil, size_t fil_sz)
{
...
void CART::read_ROM_RAM(const char* inp, size_t inp_size)
{
...
u32 CART::load_ROM_from_RAM(char* fil, u64 fil_sz)
{
