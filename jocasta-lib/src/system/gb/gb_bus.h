...
public:
	...
	void serialize_sp_obj_pointer(PPU::SPRITE *fo, serialized_state &state);
	void deserialize_sp_obj_pointer(PPU::SPRITE **fo, serialized_state &state);
