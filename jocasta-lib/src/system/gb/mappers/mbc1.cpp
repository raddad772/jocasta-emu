...
#define SELF MBC1* self = static_cast<MBC1*>(parent->ptr)
namespace GB::MAPPER {
static void MBC1_update_banks(MBC1 *self);
...
void MBC1_new(base *parent, CLOCK *clock, core *bus)
{
    MBC1 *self = (MBC1 *)malloc(sizeof(MBC1));
    ...
    parent->CPU_read = &MBC1_CPU_read;
    parent->CPU_write = &MBC1_CPU_write;
    parent->reset = &MBC1_reset;
    parent->set_cart = &MBC1_set_cart;
