...
static void macJ_IO_close_drive(jsm_system *ptr)
{

}

static void macJ_IO_remove_disc(jsm_system *ptr)
{

}

static void macJ_IO_open_drive(jsm_system *ptr) {
}
...
void core::describe_io()
{
    ...
    d->disc_drive.remove_disc = &macJ_IO_remove_disc;
    d->disc_drive.close_drive = &macJ_IO_close_drive;
    d->disc_drive.open_drive = &macJ_IO_open_drive;
    ...
    setup_crt(d->display);
    d->display.allocate_output(0, 512 * 342);
    d->display.allocate_output(1, 512 * 342);
...
u32 core::finish_frame()
{
    ...
    return display.crt->active_draw_buffer;
}
